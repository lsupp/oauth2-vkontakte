...
class Vkontakte extends AbstractProvider
{
    ...
    /* ---------- Device-ID helpers ---------- */
    private function createDeviceId(int $lengthBytes = 64): string
    {
        //$randomBytes = random_bytes($lengthBytes);
        //return rtrim(strtr(base64_encode($randomBytes), '+/', '-_'), '=');

        return "OmPEgYq7bHeqJ5sr1Y_yrzIU8A6Opf0mq0HfUT6cLjPZt8WEC7mL6WHAsxOPj51nL3VJaM9UYZFu2ldwjRSTMw";
    }
    ...
    protected function getAuthorizationParameters(array $options): array
    {
        ...
        if (!isset($options['code_challenge'])) {
            ...
            $_SESSION['vk_pkce_verifier']   = $verifier;
        }
    ...
    public function getAccessToken($grant, array $options = [])
    {
        ...
        $options['code_verifier'] = $_SESSION['vk_pkce_verifier'];
